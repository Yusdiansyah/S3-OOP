# Tugas 1 OOP
## Rancangan program menggunakan class java

## Code :
### Data Pesawat
Mendeklarasikan class yang akan digunakan sebagai blueprint dalam pembuatan kode pesawat
...
### Fungsi
Fungsi yang akan menentukan jalannya kode pesawat
```java
...
```
### Informasi Pesawat
Menampilkan data dari pesawat yang telah disusun diatas
```java
...
```
### Objek Pesawat
Digunakan untuk menjalakan kode yang telah dibuat
```java
